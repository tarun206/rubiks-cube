...
class rubiks_cube{
private:
    int face1 [256][256], face2[256][256], face3[256][256], face4[256][256], face5[256][256], face6[256][256];
public:
    void populate_faces ()
    {
    ...
    vector<char> interact()
    {
        ...
        int intermediate_buffer [256], face_choice = 0, column_choice = 0, row_choice = 0, temporary_number = 0, row_copy[256], column_copy[256];
